export const getBispoStructuredData = () => {
  return {
    ...
    description:
      "Rinaldo Silva é Bispo Sênior na Igreja Impactados, com mais de duas décadas de experiência ministerial. Conferencista internacional, já ministrou em mais de 40 países, impactando milhares de vidas através do poder do Espírito Santo.",
    sameAs: [
    ...
    knowsAbout: ["Teologia", "Dons Espirituais", "Liderança Cristã", "Ministério Pastoral", "Conferências"],
    affiliation: [
      {
        "@type": "Organization",
    ...
    award: ["Reconhecimento por Excelência Ministerial 2020", "Premio Impacto Social 2021"],
    mainEntityOfPage: {
      "@type": "WebPage",
...
export const getEscolaDonsStructuredData = () => {
  return {
    ...
    name: "Escola de Dons",
    description:
      "Descubra e desenvolva seus dons espirituais com o Bispo Rinaldo Silva. Curso completo com 5 módulos para transformar sua vida ministerial através do poder do Espírito Santo.",
    courseCode: "ED-001",
    provider: {
      "@type": "Person",
    ...
    teaches: ["Dons de Revelação", "Dons Vocais", "Dons de Poder", "Ministério de Cura", "Liderança Espiritual"],
    hasCourseInstance: {
      "@type": "CourseInstance",
...
export const getOrganizationStructuredData = () => {
  return {
    ...
    description:
      "Ministério dedicado à transformação de vidas através da palavra de Deus e do poder do Espírito Santo.",
  }
}
...
export const getLocalBusinessStructuredData = () => {
  return {
    ...
    sameAs: ["https://www.facebook.com/igrejampactados", "https://www.instagram.com/igrejampactados"],
    priceRange: "Gratuito",
