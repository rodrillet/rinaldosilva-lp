    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 flex items-center justify-center">
        <div className="container py-16 md:py-24 flex flex-col items-center text-center space-y-8">
          <div className="w-24 h-24 rounded-full bg-[#d4fb00]/20 flex items-center justify-center">
            <span className="text-4xl font-bold text-[#d4fb00]">404</span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Link href="/">
              <Button className="bg-[#d4fb00] text-black hover:bg-[#c0e500] flex items-center gap-2 w-full sm:w-auto">
          ...
          <div className="mt-12 border-t border-gray-100 pt-8">
            ...
            <ul className="flex flex-col sm:flex-row gap-4 flex-wrap justify-center">
              <li>
                <Link href="/escola-dons" className="text-[#d4fb00] hover:underline">
                  Escola de Dons
                </Link>
              </li>
              <li>
                <Link href="/#eventos" className="text-[#d4fb00] hover:underline">
                  Eventos
                </Link>
              </li>
              <li>
                <Link href="/#mensagens" className="text-[#d4fb00] hover:underline">
                  Mensagens
                </Link>
              </li>
              <li>
                <Link href="/#contato" className="text-[#d4fb00] hover:underline">
                  Contato
                </Link>
              </li>
            </ul>
      ...
      <footer className="w-full py-8 bg-black text-white">
        <div className="container text-center">
          ...
          <div className="mt-4">
            <Link href="/" className="text-sm text-gray-400 hover:text-[#d4fb00]">
